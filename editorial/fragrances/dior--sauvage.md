...
how_to_wear:
  ...
  layering_notes: Designed as a complete composition. Doesn't reward layering.
dupes:
  - house: Maison Alhambra
    name: Infinitive Aoud
    similarity: close
    price_tier: budget
    note: Strong Sauvage EDP reference with a slightly oudier dry-down. Performance comparable.
  - house: Lattafa
    name: Fakhar Black
