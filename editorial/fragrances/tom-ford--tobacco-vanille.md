...
dupes:
  - house: Maison Alhambra
    ...
    price_tier: budget
    note: Probably the closest TV clone you can buy. Tobacco-vanilla-dried-fruit accord is nearly identical; performance roughly matches the original.
  - house: Mancera
    name: Red Tobacco
    similarity: close
    price_tier: mid
    note: TV inspired but takes the tobacco much sweeter and adds a cinnamon edge. Worth it if you want TV with more spice and projection.
  - house: Lattafa
    name: Khamrah
